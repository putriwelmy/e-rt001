...
class Galeri extends Super
{
    ...
    function __construct()
    {
        ...
        $this->active_id_menu = "galeri";
        $this->nama_view      = "galeri";
        $this->status         = true; 
        $this->field_tambah   = array(); 
        $this->field_edit     = array(); 
        $this->field_tampil   = array(); 
        $this->folder_upload  = 'assets/uploads/galeri';
        $this->add            = true;
        $this->edit           = true;
        $this->delete         = true;
        $this->crud;
    ...
    function index(){
            ...
            **/
            ...
            $this->crud->set_relation('id_kategori','kategori_galeri','kategori');
